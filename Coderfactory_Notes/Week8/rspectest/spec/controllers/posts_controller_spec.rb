...
RSpec.describe PostsController, type: :controller do
  ...
  let(:valid_attributes) {
    { title: 'This is the valid title', content: 'This is the valid content text' }
  }
  ...
  describe 'GET #elephant' do
    it 'assigns the elephant instance variable' do
      comment = {'comment' => 'I am a happy elephant'}
      gets :elephant, params: {}, session: valid_session
